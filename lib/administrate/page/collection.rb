...
module Administrate
  module Page
    class Collection < Page::Base
      ...
      delegate :direction, to: :order, prefix: true
      ...
      def filter_attributes
        dashboard.filterable_attributes
      end

      def filterable_attribute_types
        dashboard.attribute_types_for(filter_attributes)
      end

      def filterable_attributes
        dashboard.filterable_attributes.map do |attr_name|
          attribute_field(dashboard, resource_class.new, attr_name, :filter)
        end
      end
